_help() {
  echo -e "[$(_c LIGHT_BLUE "Docker - List")] Usage: $(_c LIGHT_YELLOW "d.list [status] [--small|-s]")"
  ...
  echo -e "[$(_c LIGHT_BLUE "Docker - List")]   -s, --small       Show minimal output with only name and status"
  echo -e "[$(_c LIGHT_BLUE "Docker - List")]"
  ...
  echo -e "[$(_c LIGHT_BLUE "Docker - List")]   d.list exited paused --small"
}

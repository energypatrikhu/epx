...
echo -e "        $(_c LIGHT_CYAN "py.i") - Alternative command for py.install"
...
echo -e "        $(_c LIGHT_CYAN "py.rm") - Alternative command for py.remove"
echo -e "        $(_c LIGHT_CYAN "py.uninstall") - Alternative command for py.remove"

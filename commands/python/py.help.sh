...
echo -e "        $(_c LIGHT_YELLOW "py.i") - Alternative command for py.install"
...
echo -e "        $(_c LIGHT_YELLOW "py.rm") - Alternative command for py.remove"
echo -e "        $(_c LIGHT_YELLOW "py.uninstall") - Alternative command for py.remove"

...
echo -e "[$(_c LIGHT_BLUE "Minecraft - Add")] $(_c LIGHT_GREEN "Server") $(_c LIGHT_YELLOW "${server_name}") $(_c LIGHT_GREEN "of type") $(_c LIGHT_YELLOW "${server_type}") $(_c LIGHT_GREEN "created successfully at") $(_c LIGHT_YELLOW "${server_directory}")"
echo -e "[$(_c LIGHT_BLUE "Minecraft - Add")] You can now customize the configuration files and start the server using $(_c LIGHT_CYAN "mc.start ${server_name}")"

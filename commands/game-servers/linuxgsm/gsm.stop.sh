_help() {
  echo -e "[$(_c LIGHT_BLUE "LinuxGSM")] Usage: $(_c LIGHT_YELLOW "gsm.stop <game-server-tag>")"
  echo -e "[$(_c LIGHT_BLUE "LinuxGSM")] Stop a LinuxGSM game server Docker container"
  ...
  echo -e "[$(_c LIGHT_BLUE "LinuxGSM")]   gsm.stop cs2"
  echo -e "[$(_c LIGHT_BLUE "LinuxGSM")]   gsm.stop csgo-server"
}

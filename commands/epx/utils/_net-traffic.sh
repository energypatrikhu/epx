...
__net_traffic_monitor() {
  ...
  echo "╭────────────────────────────────────────────────────────────╮"
  printf "│ 🚀 REAL-TIME TRAFFIC MONITOR — %-29s │\n" "$iface"
  echo "├────────────────────────────────────────────────────────────┤"
  ...
  while true; do
    ...
    printf "│ Time: %-54s │\n" "$timestamp"
    echo "│                                                             │"
    printf "│ ▼ DOWNLOAD: %-11s %-34s │\n" "$rx_display $rx_unit" ""
    printf "│ %s │\n" "$(printf '%-59s' "$rx_graph")"
    echo "│                                                             │"
    printf "│ ▲ UPLOAD:   %-11s %-34s │\n" "$tx_display $tx_unit" ""
    printf "│ %s │\n" "$(printf '%-59s' "$tx_graph")"
    echo "│                                                             │"
    echo "├────────────────────────────────────────────────────────────┤"
    ...
    printf "│ RX Packets: %-12s  Errors: %-5s  Dropped: %-5s │\n" "$rx_packets" "$rx_errors" "$rx_dropped"
    printf "│ TX Packets: %-12s  Errors: %-5s  Dropped: %-5s │\n" "$tx_packets" "$tx_errors" "$tx_dropped"
    echo "├────────────────────────────────────────────────────────────┤"
    echo "│ Press Ctrl+C to exit                                        │"
    echo "╰────────────────────────────────────────────────────────────╯"
